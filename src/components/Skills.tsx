...
import { Layout, Server, Database, Cpu, Settings, Zap, Globe, Brain } from 'lucide-react';
  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: 'TypeScript', logo: <img src={JsLogo} alt="TypeScript" className="w-8 h-8" /> },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'GitHub Actions', logo: <img src={CICDLogo} alt="GitHub Actions" className="w-8 h-8" /> },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-700 dark:text-gray-300">
            Technical skills spanning AI/ML, NLP, RAG systems, agent architectures, and full-stack development.
          </p>
        </div>
